...
# Начальная позиция строки (координаты могут быть изменены в зависимости от вашего экрана)
line_start_position = (399, 78)  # Эти координаты нужно настроить под ваш экран и положение текста в VS Code
